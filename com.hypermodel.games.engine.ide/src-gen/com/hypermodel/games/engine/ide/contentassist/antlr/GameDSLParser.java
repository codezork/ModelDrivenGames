		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGameSpriteAccess().getXAssignment_8(), "rule__GameSprite__XAssignment_8");
					put(grammarAccess.getGameSpriteAccess().getYAssignment_10(), "rule__GameSprite__YAssignment_10");
					put(grammarAccess.getGameSpriteAccess().getHasSensorAssignment_11_0(), "rule__GameSprite__HasSensorAssignment_11_0");
					put(grammarAccess.getGameSpriteAccess().getSensorLengthAssignment_11_1(), "rule__GameSprite__SensorLengthAssignment_11_1");
					put(grammarAccess.getGameSpriteAccess().getSensorIDAssignment_11_3(), "rule__GameSprite__SensorIDAssignment_11_3");
					put(grammarAccess.getGameSpriteAccess().getInteractionSpritesAssignment_12_2(), "rule__GameSprite__InteractionSpritesAssignment_12_2");
