		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGameSpriteAccess().getAlternatives_7(), "rule__GameSprite__Alternatives_7");
					put(grammarAccess.getGameActorAccess().getAlternatives_2(), "rule__GameActor__Alternatives_2");
					put(grammarAccess.getGameActorAccess().getAlternatives_3_1(), "rule__GameActor__Alternatives_3_1");
					...
					put(grammarAccess.getGameSceneAccess().getGroup_5(), "rule__GameScene__Group_5__0");
					put(grammarAccess.getGameSceneAccess().getGroup_6(), "rule__GameScene__Group_6__0");
					put(grammarAccess.getGameLevelAccess().getGroup(), "rule__GameLevel__Group__0");
					...
					put(grammarAccess.getGameMessageAccess().getGroup(), "rule__GameMessage__Group__0");
					...
					put(grammarAccess.getGameSpriteAccess().getGroup_7_0_0(), "rule__GameSprite__Group_7_0_0__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_7_0_0_1(), "rule__GameSprite__Group_7_0_0_1__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_7_0_2(), "rule__GameSprite__Group_7_0_2__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_7_1(), "rule__GameSprite__Group_7_1__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_7_2_0(), "rule__GameSprite__Group_7_2_0__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_7_2_0_1(), "rule__GameSprite__Group_7_2_0_1__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_7_2_1(), "rule__GameSprite__Group_7_2_1__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_8(), "rule__GameSprite__Group_8__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_9_0(), "rule__GameSprite__Group_9_0__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_9_1(), "rule__GameSprite__Group_9_1__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_9_2(), "rule__GameSprite__Group_9_2__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_9_3(), "rule__GameSprite__Group_9_3__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_9_3_6(), "rule__GameSprite__Group_9_3_6__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_9_4(), "rule__GameSprite__Group_9_4__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_9_5(), "rule__GameSprite__Group_9_5__0");
					...
					put(grammarAccess.getGameActorAccess().getGroup_1(), "rule__GameActor__Group_1__0");
					put(grammarAccess.getGameActorAccess().getGroup_2_0(), "rule__GameActor__Group_2_0__0");
					put(grammarAccess.getGameActorAccess().getGroup_2_1(), "rule__GameActor__Group_2_1__0");
					put(grammarAccess.getGameActorAccess().getGroup_3(), "rule__GameActor__Group_3__0");
					put(grammarAccess.getGameActorAccess().getGroup_3_1_0(), "rule__GameActor__Group_3_1_0__0");
					put(grammarAccess.getGameActorAccess().getGroup_3_1_1(), "rule__GameActor__Group_3_1_1__0");
					...
					put(grammarAccess.getGameRootAccess().getScreensAssignment_26_1_2(), "rule__GameRoot__ScreensAssignment_26_1_2");
					put(grammarAccess.getGameRootAccess().getRegionsAssignment_26_2_2(), "rule__GameRoot__RegionsAssignment_26_2_2");
					...
					put(grammarAccess.getGameScreenAccess().getScenesAssignment_7(), "rule__GameScreen__ScenesAssignment_7");
					put(grammarAccess.getGameScreenAccess().getGameOverSceneAssignment_10(), "rule__GameScreen__GameOverSceneAssignment_10");
					put(grammarAccess.getGameScreenAccess().getLevelsAssignment_13(), "rule__GameScreen__LevelsAssignment_13");
					put(grammarAccess.getGameScreenAccess().getTilesAssignment_17(), "rule__GameScreen__TilesAssignment_17");
					put(grammarAccess.getGameScreenAccess().getSpritesAssignment_21(), "rule__GameScreen__SpritesAssignment_21");
					put(grammarAccess.getGameSceneAccess().getNameAssignment_2(), "rule__GameScene__NameAssignment_2");
					put(grammarAccess.getGameSceneAccess().getTopPaddingAssignment_4(), "rule__GameScene__TopPaddingAssignment_4");
					put(grammarAccess.getGameSceneAccess().getDisplaysAssignment_5_2(), "rule__GameScene__DisplaysAssignment_5_2");
					put(grammarAccess.getGameSceneAccess().getMessagesAssignment_6_2(), "rule__GameScene__MessagesAssignment_6_2");
					put(grammarAccess.getGameLevelAccess().getNameAssignment_2(), "rule__GameLevel__NameAssignment_2");
					put(grammarAccess.getGameLevelAccess().getFileNameAssignment_4(), "rule__GameLevel__FileNameAssignment_4");
					...
					put(grammarAccess.getGameMessageAccess().getNameAssignment_2(), "rule__GameMessage__NameAssignment_2");
					put(grammarAccess.getGameMessageAccess().getMessageAssignment_4(), "rule__GameMessage__MessageAssignment_4");
					put(grammarAccess.getGameMessageAccess().getRowAssignment_6(), "rule__GameMessage__RowAssignment_6");
					...
					put(grammarAccess.getGameSpriteAccess().getIsEnemyAssignment_7_0_0_0(), "rule__GameSprite__IsEnemyAssignment_7_0_0_0");
					put(grammarAccess.getGameSpriteAccess().getLayerAssignment_7_0_0_1_1(), "rule__GameSprite__LayerAssignment_7_0_0_1_1");
					put(grammarAccess.getGameSpriteAccess().getIsDestructableAssignment_7_0_1(), "rule__GameSprite__IsDestructableAssignment_7_0_1");
					put(grammarAccess.getGameSpriteAccess().getHasActivationRuleAssignment_7_0_2_0(), "rule__GameSprite__HasActivationRuleAssignment_7_0_2_0");
					put(grammarAccess.getGameSpriteAccess().getRuleAssignment_7_0_2_2(), "rule__GameSprite__RuleAssignment_7_0_2_2");
					put(grammarAccess.getGameSpriteAccess().getIsItemAssignment_7_1_0(), "rule__GameSprite__IsItemAssignment_7_1_0");
					put(grammarAccess.getGameSpriteAccess().getIsDestructableAssignment_7_1_1(), "rule__GameSprite__IsDestructableAssignment_7_1_1");
					put(grammarAccess.getGameSpriteAccess().getIsPlayerAssignment_7_2_0_0(), "rule__GameSprite__IsPlayerAssignment_7_2_0_0");
					put(grammarAccess.getGameSpriteAccess().getStartPositionAssignment_7_2_0_1_1(), "rule__GameSprite__StartPositionAssignment_7_2_0_1_1");
					put(grammarAccess.getGameSpriteAccess().getInputsAssignment_7_2_1_2(), "rule__GameSprite__InputsAssignment_7_2_1_2");
					put(grammarAccess.getGameSpriteAccess().getHasVelocityAssignment_8_0(), "rule__GameSprite__HasVelocityAssignment_8_0");
					put(grammarAccess.getGameSpriteAccess().getVelocityAssignment_8_1(), "rule__GameSprite__VelocityAssignment_8_1");
					put(grammarAccess.getGameSpriteAccess().getHasSensorAssignment_9_0_0(), "rule__GameSprite__HasSensorAssignment_9_0_0");
					put(grammarAccess.getGameSpriteAccess().getVectors2dAssignment_9_0_2(), "rule__GameSprite__Vectors2dAssignment_9_0_2");
					put(grammarAccess.getGameSpriteAccess().getSensorIDAssignment_9_0_5(), "rule__GameSprite__SensorIDAssignment_9_0_5");
					put(grammarAccess.getGameSpriteAccess().getActorsAssignment_9_1_2(), "rule__GameSprite__ActorsAssignment_9_1_2");
					put(grammarAccess.getGameSpriteAccess().getPropertiesAssignment_9_2_2(), "rule__GameSprite__PropertiesAssignment_9_2_2");
					put(grammarAccess.getGameSpriteAccess().getStatesAssignment_9_3_2(), "rule__GameSprite__StatesAssignment_9_3_2");
					put(grammarAccess.getGameSpriteAccess().getInitialStateAssignment_9_3_5(), "rule__GameSprite__InitialStateAssignment_9_3_5");
					put(grammarAccess.getGameSpriteAccess().getHasGameOverStateAssignment_9_3_6_0(), "rule__GameSprite__HasGameOverStateAssignment_9_3_6_0");
					put(grammarAccess.getGameSpriteAccess().getGameOverStateAssignment_9_3_6_1(), "rule__GameSprite__GameOverStateAssignment_9_3_6_1");
					put(grammarAccess.getGameSpriteAccess().getEventsAssignment_9_4_2(), "rule__GameSprite__EventsAssignment_9_4_2");
					put(grammarAccess.getGameSpriteAccess().getHasRestitutionAssignment_9_5_0(), "rule__GameSprite__HasRestitutionAssignment_9_5_0");
					put(grammarAccess.getGameSpriteAccess().getRestitutionAssignment_9_5_1(), "rule__GameSprite__RestitutionAssignment_9_5_1");
					...
					put(grammarAccess.getGameActorAccess().getHasCollisionConditionAssignment_1_0(), "rule__GameActor__HasCollisionConditionAssignment_1_0");
					put(grammarAccess.getGameActorAccess().getTypeAAssignment_1_1(), "rule__GameActor__TypeAAssignment_1_1");
					put(grammarAccess.getGameActorAccess().getTypeBAssignment_1_3(), "rule__GameActor__TypeBAssignment_1_3");
					put(grammarAccess.getGameActorAccess().getSpriteAssignment_2_0_1(), "rule__GameActor__SpriteAssignment_2_0_1");
					put(grammarAccess.getGameActorAccess().getTileAssignment_2_1_1(), "rule__GameActor__TileAssignment_2_1_1");
					put(grammarAccess.getGameActorAccess().getHasCollisionConsequenceAssignment_3_0(), "rule__GameActor__HasCollisionConsequenceAssignment_3_0");
					put(grammarAccess.getGameActorAccess().getBeginContactAssignment_3_1_0_1(), "rule__GameActor__BeginContactAssignment_3_1_0_1");
					put(grammarAccess.getGameActorAccess().getEndContactAssignment_3_1_1_1(), "rule__GameActor__EndContactAssignment_3_1_1_1");
					...
					put(grammarAccess.getGameSpriteAccess().getUnorderedGroup_7_0(), "rule__GameSprite__UnorderedGroup_7_0");
					put(grammarAccess.getGameSpriteAccess().getUnorderedGroup_7_2(), "rule__GameSprite__UnorderedGroup_7_2");
					put(grammarAccess.getGameSpriteAccess().getUnorderedGroup_9(), "rule__GameSprite__UnorderedGroup_9");
				}
			};
		}
