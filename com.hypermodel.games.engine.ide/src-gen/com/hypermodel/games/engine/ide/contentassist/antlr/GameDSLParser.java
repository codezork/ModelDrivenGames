		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGameSpriteAccess().getGroup_19(), "rule__GameSprite__Group_19__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_20(), "rule__GameSprite__Group_20__0");
					...
					put(grammarAccess.getGameModelAccess().getPackagesAssignment(), "rule__GameModel__PackagesAssignment");
					put(grammarAccess.getGameImportAccess().getImportedNamespaceAssignment_1(), "rule__GameImport__ImportedNamespaceAssignment_1");
					put(grammarAccess.getGamePackageAccess().getNameAssignment_1(), "rule__GamePackage__NameAssignment_1");
					put(grammarAccess.getGamePackageAccess().getImportsAssignment_3(), "rule__GamePackage__ImportsAssignment_3");
					put(grammarAccess.getGamePackageAccess().getConfigAssignment_4(), "rule__GamePackage__ConfigAssignment_4");
					...
					put(grammarAccess.getGameSpriteAccess().getAnimationsAssignment_7_2(), "rule__GameSprite__AnimationsAssignment_7_2");
					put(grammarAccess.getGameSpriteAccess().getStandsAssignment_10(), "rule__GameSprite__StandsAssignment_10");
					put(grammarAccess.getGameSpriteAccess().getStartAssignment_13(), "rule__GameSprite__StartAssignment_13");
					put(grammarAccess.getGameSpriteAccess().getXAssignment_16(), "rule__GameSprite__XAssignment_16");
					put(grammarAccess.getGameSpriteAccess().getYAssignment_18(), "rule__GameSprite__YAssignment_18");
					put(grammarAccess.getGameSpriteAccess().getHasSensorAssignment_19_0(), "rule__GameSprite__HasSensorAssignment_19_0");
					put(grammarAccess.getGameSpriteAccess().getSensorLengthAssignment_19_1(), "rule__GameSprite__SensorLengthAssignment_19_1");
					put(grammarAccess.getGameSpriteAccess().getSensorIDAssignment_19_3(), "rule__GameSprite__SensorIDAssignment_19_3");
					put(grammarAccess.getGameSpriteAccess().getInteractionSpritesAssignment_20_2(), "rule__GameSprite__InteractionSpritesAssignment_20_2");
