		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGameSpriteAccess().getGroup_7_0_3(), "rule__GameSprite__Group_7_0_3__0");
					...
					put(grammarAccess.getGameSpriteAccess().getGroup_8_0(), "rule__GameSprite__Group_8_0__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_8_1(), "rule__GameSprite__Group_8_1__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_8_2(), "rule__GameSprite__Group_8_2__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_8_3(), "rule__GameSprite__Group_8_3__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_8_3_6(), "rule__GameSprite__Group_8_3_6__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_8_4(), "rule__GameSprite__Group_8_4__0");
					put(grammarAccess.getGameSpriteAccess().getGroup_8_5(), "rule__GameSprite__Group_8_5__0");
					...
					put(grammarAccess.getGameSpriteAccess().getHasVelocityAssignment_7_0_2_0(), "rule__GameSprite__HasVelocityAssignment_7_0_2_0");
					put(grammarAccess.getGameSpriteAccess().getVelocityAssignment_7_0_2_1(), "rule__GameSprite__VelocityAssignment_7_0_2_1");
					put(grammarAccess.getGameSpriteAccess().getHasActivationRuleAssignment_7_0_3_0(), "rule__GameSprite__HasActivationRuleAssignment_7_0_3_0");
					put(grammarAccess.getGameSpriteAccess().getRuleAssignment_7_0_3_2(), "rule__GameSprite__RuleAssignment_7_0_3_2");
					put(grammarAccess.getGameSpriteAccess().getIsItemAssignment_7_1_0_0(), "rule__GameSprite__IsItemAssignment_7_1_0_0");
					put(grammarAccess.getGameSpriteAccess().getIsDestructableAssignment_7_1_0_1(), "rule__GameSprite__IsDestructableAssignment_7_1_0_1");
					put(grammarAccess.getGameSpriteAccess().getHasVelocityAssignment_7_1_1_0(), "rule__GameSprite__HasVelocityAssignment_7_1_1_0");
					put(grammarAccess.getGameSpriteAccess().getVelocityAssignment_7_1_1_1(), "rule__GameSprite__VelocityAssignment_7_1_1_1");
					...
					put(grammarAccess.getGameSpriteAccess().getHasSensorAssignment_8_0_0(), "rule__GameSprite__HasSensorAssignment_8_0_0");
					put(grammarAccess.getGameSpriteAccess().getVectors2dAssignment_8_0_2(), "rule__GameSprite__Vectors2dAssignment_8_0_2");
					put(grammarAccess.getGameSpriteAccess().getSensorIDAssignment_8_0_5(), "rule__GameSprite__SensorIDAssignment_8_0_5");
					put(grammarAccess.getGameSpriteAccess().getActorsAssignment_8_1_2(), "rule__GameSprite__ActorsAssignment_8_1_2");
					put(grammarAccess.getGameSpriteAccess().getPropertiesAssignment_8_2_2(), "rule__GameSprite__PropertiesAssignment_8_2_2");
					put(grammarAccess.getGameSpriteAccess().getStatesAssignment_8_3_2(), "rule__GameSprite__StatesAssignment_8_3_2");
					put(grammarAccess.getGameSpriteAccess().getInitialStateAssignment_8_3_5(), "rule__GameSprite__InitialStateAssignment_8_3_5");
					put(grammarAccess.getGameSpriteAccess().getGameOverStateAssignment_8_3_6_1(), "rule__GameSprite__GameOverStateAssignment_8_3_6_1");
					put(grammarAccess.getGameSpriteAccess().getEventsAssignment_8_4_2(), "rule__GameSprite__EventsAssignment_8_4_2");
					put(grammarAccess.getGameSpriteAccess().getHasRestitutionAssignment_8_5_0(), "rule__GameSprite__HasRestitutionAssignment_8_5_0");
					put(grammarAccess.getGameSpriteAccess().getRestitutionAssignment_8_5_1(), "rule__GameSprite__RestitutionAssignment_8_5_1");
					...
					put(grammarAccess.getGameSpriteAccess().getUnorderedGroup_7_1(), "rule__GameSprite__UnorderedGroup_7_1");
					put(grammarAccess.getGameSpriteAccess().getUnorderedGroup_7_2(), "rule__GameSprite__UnorderedGroup_7_2");
					put(grammarAccess.getGameSpriteAccess().getUnorderedGroup_8(), "rule__GameSprite__UnorderedGroup_8");
				}
			};
		}
