...
import com.hypermodel.games.engine.formatting2.GameDSLFormatter;
import com.hypermodel.games.engine.jvmmodel.GameDSLJvmModelInferrer;
import com.hypermodel.games.engine.parser.antlr.GameDSLAntlrTokenFileProvider;
import com.hypermodel.games.engine.parser.antlr.GameDSLParser;
import com.hypermodel.games.engine.parser.antlr.internal.InternalGameDSLLexer;
import com.hypermodel.games.engine.scoping.GameDSLScopeProvider;
import com.hypermodel.games.engine.serializer.GameDSLSemanticSequencer;
import com.hypermodel.games.engine.serializer.GameDSLSyntacticSequencer;
...
public abstract class AbstractGameDSLRuntimeModule extends DefaultXbaseWithAnnotationsRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "com/hypermodel/games/engine/GameDSL.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("com.hypermodel.games.engine.GameDSL");
	}
