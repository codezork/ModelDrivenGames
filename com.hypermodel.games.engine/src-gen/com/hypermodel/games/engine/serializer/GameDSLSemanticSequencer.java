...
public class GameDSLSemanticSequencer extends XbaseWithAnnotationsSemanticSequencer {
	 ...
	 */
	protected void sequence_GameImport(ISerializationContext context, GameImport semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, GameDSLPackage.Literals.GAME_IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, GameDSLPackage.Literals.GAME_IMPORT__IMPORTED_NAMESPACE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getGameImportAccess().getImportedNamespaceGameQualifiedNameWithWildCardParserRuleCall_1_0(), semanticObject.getImportedNamespace());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     GamePlatformConfiguration returns GamePlatformConfiguration
	 *
	 * Constraint:
	 *     (platform=GamePlatform config+=GamePlatformConfigAndroid*)
	 */
	protected void sequence_GamePlatformConfiguration(ISerializationContext context, GamePlatformConfiguration semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *
	 * Constraint:
	 *     (name=ID (hasScore?='isScore' score=GameScore)?)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID atlasName=STRING scene=[GameScene|ID] sprites+=GameSprite*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=ID offset=INT region=[GameTextureRegion|ID])
	 */
	protected void sequence_GameSpriteStand(ISerializationContext context, GameSpriteStand semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getGameSpriteStandAccess().getNameIDTerminalRuleCall_2_0(), semanticObject.getName());
	...
	protected void sequence_GameTextureRegion(ISerializationContext context, GameTextureRegion semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getGameTextureRegionAccess().getNameIDTerminalRuleCall_2_0(), semanticObject.getName());
