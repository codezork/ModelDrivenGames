...
public class GameDSLJvmModelInferrer extends AbstractModelInferrer {
  ...
  protected void _infer(final GamePackage gamePkg, final IJvmDeclaredTypeAcceptor acceptor, final boolean isPreIndexingPhase) {
    ...
    for (final GameRoot game : _games) {
      {
        String rootClassName = StringExtensions.toFirstUpper(game.getName());
        final JvmGenericType rootClass = this._jvmTypesBuilder.toClass(gamePkg, rootClassName);
        rootClass.getSuperTypes().add(this._typeReferenceBuilder.typeRef(Game.class));
        ...
        for (final GameProperties.ProjectType pType : _values) {
          ...
          if (_notEquals) {
            this.createLauncher(acceptor, gamePkg, game, pkgName, pType);
          }
        }
  ...
  protected void createLauncher(final IJvmDeclaredTypeAcceptor acceptor, final GamePackage gamePkg, final GameRoot game, final String pkgName, final GameProperties.ProjectType pType) {
          ...
          final Procedure1<JvmGenericType> _function_1 = (JvmGenericType it) -> {
            final Procedure1<JvmOperation> _function_2 = (JvmOperation it_1) -> {
              ...
              final Procedure1<ITreeAppendable> _function_3 = (ITreeAppendable it_2) -> {
                ...
                _builder_2.append(".");
                String _firstUpper_2 = StringExtensions.toFirstUpper(game.getName());
    ...
    final Procedure1<JvmOperation> _function = (JvmOperation it) -> {
      ...
      final Procedure1<ITreeAppendable> _function_1 = (ITreeAppendable it_1) -> {
        ...
        _builder.newLine();
        {
          EList<GameScreen> _screens = game.getScreens();
          for(final GameScreen screen : _screens) {
            _builder.append("setScreen(new ");
            String _string = this._iQualifiedNameProvider.getFullyQualifiedName(gamePkg).toString();
            String _plus = (_string + ".screens");
            _builder.append(_plus);
            _builder.append(".");
            String _firstUpper = StringExtensions.toFirstUpper(screen.getName());
            _builder.append(_firstUpper);
  ...
  public void createScreen(final IJvmDeclaredTypeAcceptor acceptor, final GamePackage gamePkg, final JvmGenericType gameClass, final GameScreen screen) {
    String screenClassName = StringExtensions.toFirstUpper(screen.getName());
    final JvmGenericType screenClass = this._jvmTypesBuilder.toClass(gamePkg, screenClassName);
    screenClass.getSuperTypes().add(this._typeReferenceBuilder.typeRef(Screen.class));
    String _string = this._iQualifiedNameProvider.getFullyQualifiedName(gamePkg).toString();
    final String pkgName = (_string + ".screens");
    final Procedure1<JvmGenericType> _function = (JvmGenericType it) -> {
      EList<JvmMember> _members = it.getMembers();
  ...
  public void toFields(final JvmGenericType type, final GameScreen screen, final JvmGenericType gameClass) {
    JvmField field = null;
    field = this._jvmTypesBuilder.toField(screen, "game", this._typeReferenceBuilder.typeRef(gameClass));
    EList<JvmMember> _members = type.getMembers();
    this._jvmTypesBuilder.<JvmField>operator_add(_members, field);
    field = this._jvmTypesBuilder.toField(screen, "atlas", this._typeReferenceBuilder.typeRef(TextureAtlas.class));
    EList<JvmMember> _members_1 = type.getMembers();
    this._jvmTypesBuilder.<JvmField>operator_add(_members_1, field);
    EList<JvmMember> _members_2 = type.getMembers();
